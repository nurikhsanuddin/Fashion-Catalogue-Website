...
<head>
    ...
    <title>Katalog Celana - SANDIN Fashion</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <h1 class="text-center mb-4 fw-bolder" style="font-weight: bold !important;">Katalog Celana</h1>
        ...
        <div class="row">
            ...
            $query = "SELECT * FROM katalog WHERE kategori = 'celana'";
