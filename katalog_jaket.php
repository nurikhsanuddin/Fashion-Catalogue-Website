...
<head>
    ...
    <title>Katalog Jaket - SANDIN Fashion</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <h1 class="text-center mb-4 fw-bolder" style="font-weight: bold !important;">Katalog Jaket</h1>
        ...
        <div class="row">
            ...
            $query = "SELECT * FROM katalog WHERE kategori = 'jaket'";
